    ...
    const mockSpans: Span[] = [
      {
        ...
        end_time: trace.start_time + trace.duration_ms,
      ...
      },
      {
        ...
        start_time: trace.start_time + 50,
        end_time: trace.start_time + trace.duration_ms - 10,
      ...
      },
      {
        ...
        start_time: trace.start_time + 10,
        end_time: trace.start_time + 40,
        duration_ms: 30,
        status: 'ok',
        attributes: {
          ...
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge variant="outline">{selectedTrace.span_count} spans</Badge>
