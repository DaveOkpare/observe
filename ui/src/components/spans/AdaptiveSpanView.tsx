  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        <span className="text-xs rounded border px-2 py-0.5 bg-muted dark:bg-gray-800">Unknown Type</span>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
            {Object.entries(meaningfulFields).map(([key, value]) => (
              <div key={key} className="flex justify-between p-2 bg-muted dark:bg-gray-800 rounded">
